...
public class OAuth2UserDetailsLoaderImpl implements OAuth2UserDetailsLoader {
    ...
    public UserDetails getUserByUserId(Object id) {
        if (!userService.isUserExist((String) id)) {
            ...
            com.qreal.wmp.dashboard.database.users.model.User user = userService.findByUserName((String) id);
            return convert(user);
        }
    }
    ...
    public UserDetails createUser(Object id, Map userInfo) {
        com.qreal.wmp.dashboard.database.users.model.User user = new com.qreal.wmp.dashboard.database.users.model.User((String) id,
                (String) id, true);
    ...
    private User convert(com.qreal.wmp.dashboard.database.users.model.User user) {
